...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.pt/"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.pt/tutoriais/"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Tutoriais</a>
                </li>
                <li>
                    <a href="https://www.hostinger.pt/make-money-online"><i aria-hidden="true" class="fa fa-trophy"></i> Ganhe conosco</a>
                </li>
                <li>
                    <a href="https://www.hostinger.pt/affiliate-program/login"><i aria-hidden="true" class="fa fa-user"></i> Afiliados</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.pt"><i aria-hidden="true" class="fa fa-lock"></i> Login</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Sua conta foi criada</h1><i></i>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.pt/make-money-online">Saiba mais</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.pt/base-de-conhecimento">Saiba mais</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com/blog/">Saiba mais</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://www.hostinger.pt/hospedagem-web">Hospedagem Web</a> |
                    <a href="https://cpanel.hostinger.pt">Login do Cliente</a>
                </div>
